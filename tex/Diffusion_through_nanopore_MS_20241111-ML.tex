...
\begin{figure}
    \centering
    % \includegraphics[width=0.4\linewidth]{fig/chi_PC_crit_on_d.png}
    % \includegraphics[width=0.4\linewidth]{fig/resistivity_on_chi_PC.png}
    \includegraphics[width=0.8\linewidth]{fig/chi_PC_crit_on_d_and_resistivity_on_chi_PC.png}
    \caption{
