...
\begin{figure}[H]
    ...
    \caption{Volume and surface occupancy matrices for cylindrical particle with the diameter and height $d=8$}
...
In Figure \ref{fig:cylindrical_kernel_SI} we present a color visualization for the volume $\mathbf{V}_{\textrm{cyl}}$ and surface $\mathbf{V}_{\textrm{cyl}}$ occupancy matrices of a cylindrical particle with the diameter and the height $d=8$.
...
\begin{figure}
    \centering
    \vspace{-1cm}
    \includegraphics[width = 0.8\textwidth]{fig/insertion_chi_PS=0.5_chi_PC=0_d=16_pc=-26.png}\\
    \vspace{-1cm}
    \includegraphics[width = 0.8\textwidth]{fig/insertion_chi_PS=0.5_chi_PC=-1.5_d=16_pc=-26.png}
    \vspace{-1cm}
    \caption{
