...
% \begin{equation}
%     R_{pore}=\int_{0}^{L}\left(\int_{0}^{r_{\text{pore}}}2\pi rdrD(r, z')e^{-\Delta F(r,z')}\right)^{-1}dz'
%     \label{eq:res_with_brush}
% \end{equation}
    
% \noindent The product $D(r,z')e^{-\Delta F(r,z')}$ here has the meaning of local conductivity, 
