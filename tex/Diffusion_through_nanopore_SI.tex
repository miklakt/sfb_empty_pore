...
\begin{figure}[]
    ...
    \todo{RR: Mikhail, please replace $c_\text{cytosol}$ by $c_0$ and remove $V_\text{cytosol}$.}
...
\begin{figure}[]
    ...
    Theoretical predictions are presented as in Figure~8b for a colloid surface with a single sticky patch (orange lines and shaded area).
    ...
    The experimental data from Figure~8b are also shown (grey symbols), for comparison. 
    \todo{RR: Mikhail, in the figure please repreplace $\phi_\text{gel}$ by $\phi_\text{FG droplet}$, and remove 'one' on the label for the $y$ axis.}
    }
