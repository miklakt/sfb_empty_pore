...
\begin{figure*}[htp!]
    ...
    \caption{
        ...
        The pore radius is $r_\text{pore}$, and the thickness of the membrane is $L_{0}$.
...
\begin{gather}
    ...
    \begin{aligned}
        &f(x_z) =\\
        & = \frac{2(|x_z|-L/2)^2 + 2r_{\text{p}}^{0}^2}{(3(|x_z|-L/2)+r_{\text{p}}^{0})((|x_z|-L/2)+r_{\text{p}}^{0})}
    \end{aligned}
\end{gather}
...
\begin{equation}
    ...
    J = \oint\limits_{S} \mathbf{j} \cdot d\mathbf{S} = 2 \pi \int_0^{r_\text{pore}} j_z(r, z = 0) \, r \, dr
\end{equation}
...
\begin{equation}
    ...
    J = \frac{\pi}{4} j_z[ r = 0, z = 0 ] + \pi \sum_{r = 1}^{r_\text{pore}} 2 r \, j_z[ r, z = 0 ]
\end{equation}
