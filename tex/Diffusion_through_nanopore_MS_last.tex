...
%forms a cubic parabola (in logarithmic coordinated) with an inflection (for $\gamma\!=\!0$) or a maximum/minimum pair (for $\gamma\!<\!0$).
...
% % It is known that even relatively large colloid particles that are considered inert may leak through a nucleopore (\totdo Ref Popen et al ) on the timescale of hours which can be attributed...
