...
will decrease $\gamma$ throughout the polymer filling.
A decrease of $\chi_{\text{PC}}$ below $\chi_{\text{ads}}^{\text{crit}}$ makes $\gamma<0$, then
...
Because of the contributions of diffusion slowdown due to the polymer meshwork, the extrema disappear when $\chi_{\text{PC}}$ and $\gamma$ is not sufficiently negative or shifted leading to non-monotonic $R(d)$ for sufficiently negative $\chi_{\text{PC}}$ and $\gamma$.

Up until $\chi_{\text{PC}}$ and $\gamma$ is not sufficiently negative the insertion free energy landscape is still mostly positive or slightly negative with $R(d)$ being monotonically increasing, within the scaling $d^3 \lesssim R(d) \lesssim \exp(d^3)$ for smaller particles when $\Delta F(d)$ is slightly negative, followed by $R \gtrsim \exp(d^3)$ when particles become larger and $\Delta F(d)>0$.
This regime of $R(d)$ scaling in Figure~\ref{fig:R_vs_d}a) corresponds to $\chi_{\text{PC}} = -1.0$ or slightly below at $\chi_{\text{PS}} = 0.5$ (with $\chi_{\text{PC}}<-0.7$ driving $\gamma \le 0$ everywhere), or $\chi_{\text{PS}} = 0.3$ and $\chi_{\text{PS}} = 0.4$ at $\chi_{\text{PC}} = -1.25$ in Figure~\ref{fig:R_vs_d}b.

Further decrease in $\chi_{\text{PC}}$ drives $\gamma$ and $\Delta F(d)$ sufficiently negative such that $R(d)$ is non-monotonic the maximum to a some finite particle size, noted in Figure~\ref{fig:R_vs_d}a with \raisebox{0.25em}{\scriptsize$\uparrow$}(a) and minimum noted in Figure~\ref{fig:R_vs_d}a with \raisebox{0.25em}{\scriptsize$\uparrow$}(b).
The pore became extremely sensitive to pore when the particle size become larger than the one that correspond to the minimum in $R(d)$ (\raisebox{0.25em}{\scriptsize$\uparrow$}(b) in Figure~\ref{fig:R_vs_d}a) as $\Delta F(d)>0$ with $R \gtrsim \exp(d^3)$ scaling.
Thus for the particles with sufficiently attractive surface controlled by  $\chi_{\text{ads}}(\chi_{\text{PC}}, \chi_{\text{PS}})$, the pore acts as a gate, that have little or no sensitivity to particles size, below some particle size size, and become restrictive as particle hits some critical size, as exemplified in Figure~\ref{fig:R_vs_d}ab for a set of parameters $\chi_{\text{PS}} = 0.5$ at $\chi_{\text{PC}} = -1.25$.
