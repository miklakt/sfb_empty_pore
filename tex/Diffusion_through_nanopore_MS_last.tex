...
%         \\
%         &
%         =\underset{\text{(i)}}{ \frac{2 \alpha \phi^{2} d}{\alpha \phi^{2} d^{2} + 1} +\frac{1}{d}}
%         \underset{\text{(ii)}}{+ \frac{\pi \Pi\{\tilde{\phi}\} d^{2}}{2}}
%         \underset{\text{(iii)}}{\vphantom{\frac{a}{a}}+ 2 \pi \gamma d}
