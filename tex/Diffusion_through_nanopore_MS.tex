...
\begin{figure}
    ...
    \caption{
        ...
        %COMMENT RR: What is the purpose of the circle symbols on the lines - can we remove these for simplicity?
        %Comment RR: Why do we not show poor solvent data - presumably, this is intentional to avoid the regime of negative osmotic pressure? If not, can we at least add moderately poor solvent (0.6) to provide a sense of the trends in this regime?
        \\
        Pore and brush parameters are as given in Figure~\ref{fig:colloid_transport}.
    }
