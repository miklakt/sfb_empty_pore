...
SF-SCF simulations were performed with Namics.
\todo{Mikhail, please can you add the following reference here: F. A. M. Leermakers, R. Varadharajan, D. Emmery and A. Kazakov, Namics - MD-SCF Hybrid simulation tool, 2023, https://github.com/leermakers/Namics. I am not sure how to integrate web links into the bib file.}
Custom code for other modelling and data aanalysis is available on \url{https://github.com/miklakt/diffusion_polymer_mesopores}.
...
Also,please display all authors for all references. I think there is no paper with too many authors.
Thanks!}
